<x-auth-card title="Reset Password" subtitle="Choose a new password for your organizer account." portal="Organizer Portal">
    <form method="POST" action="{{ route('organizer.password.update') }}" class="space-y-5">
        @csrf
