<x-layouts.app title="About">
    <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-16 lg:px-8">
        <p class="text-sm font-semibold uppercase tracking-wide text-brand">About MyTicket</p>
        ...
        <div class="mt-5 space-y-4 text-sm leading-relaxed text-neutral-600 sm:mt-8 sm:space-y-5 sm:text-base">
            <p>
                MyTicket is an online ticketing platform built for event organizers and the people who love going to
                events. Whether it's a concert, a party, a conference, or a festival, MyTicket makes it easy to publish
            ...
            <p>
                For organizers, MyTicket keeps things simple too: publish your event, set your ticket types and prices,
